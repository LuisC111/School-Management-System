...
<head>
    ...
    <title>Contacténos | C.A.R.P</title>
...
<?php include('includes/menuPublico.php') ?>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <p>
                    Bogotá D.C<br>Sosiego<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">Telefono</abbr>: 3024358217</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">Email</abbr>: <a href="mailto:lmartinez@arp.edu.co">lmmartinez@arp.edu.co</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">Horario</abbr>: Lunes a Viernes: 7:00 AM - 3:00 PM</p>
      ...
      <div class="row">
            <div class="col-md-8">
                <h3>¿Tienes Dudas? Envianos un Mensaje</h3>
