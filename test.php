...
<head>
    ...
    <title>Colegio Técnico Aldemar Rojas Plazas | C.A.R.P</title>
...
<?php include('includes/menuPublico.php') ?>
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <div class="fill" style="background-image:url('https://arp.edu.co/wp-content/uploads/2020/03/Visita-Beff-2019.png');"></div>
                <div class="carousel-caption">
                </div>
            </div>
            <div class="item">
                <div class="fill" style="background-image:url('https://pbs.twimg.com/media/DIZ-aH8W4AAcLHe.jpg');"></div>
                <div class="carousel-caption">
                </div>
            </div>
            <div class="item">
                <div class="fill" style="background-image:url('https://mapio.net/images-p/25592868.jpg');"></div>
                <div class="carousel-caption">
                </div>
            </div>
            <div class="item">
                <div class="fill" style="background-image:url('https://3.bp.blogspot.com/_1U0xhc85LQ8/S9MKP4dmgDI/AAAAAAAABPg/NEzBDurYY7I/s1600/S4031502.jpg');"></div>
                <div class="carousel-caption">
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                     Bienvenido | Colegio Técnico Aldemar Rojas Plazas
                </h1>
            </div>
            <div class="col-lg-12">
                <p>
                     Bienvenidos al Sistema de Informacion Aldemar Rojas Plazas
                <p>
                <br>
            </div>
             <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        <h4>Administrador</h4>
                        <p>Esta seccion es solo para los administradores, este es el encargado de administrar y supervisar todas las actividades de todos los usuarios (estudiantes y docentes) y lo relacionado con la parte academica.</p>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header">Que puedes hacer con C.A.R.P admin</h2>
            </div>
            <div class="col-md-6">
                <p>Con el sistema de administracion docente, puedes realizar todas las actividades necesarias que faciliten el manejo del area academica del colegio, entre algunas de las actividades tenemos:</p>
                <ul>
